...
public partial class GameOverScreen : Node
{
    ...
    public override void _Ready()
    {
        if (canvasLayer == null)
        {
            Logger.Fatal("CanvasLayer not assigned on game over screen");
        }
         if (canvasLayer == null)
        {
            Logger.Fatal("CanvasLayer not assigned on game over screen");
        ...
        {
            Logger.Fatal("MasterSlider not assigned on game over screen");
        }
        
        if (SFXSlider == null)
        {
            Logger.Fatal("SFXSlider not assigned on game over screen");
        }
        
        if (MusicSlider == null)
        {
            Logger.Fatal("MusicSlider not assigned on game over screen");
        }
